...
export default function SideBar(){
    ...
    return (
        <aside className="absolute left-0 top-0 z-50 flex h-screen w-72 flex-col overflow-y-hidden text-slate-200 bg-neutral-900 duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 -translate-x-full" id="sidebar">
            <div className="flex items-center justify-between gap-10 px-6 py-5 lg:py-6.5">
                <a href="#">
                    <img src={logo} alt="" />
                </a>
                <button onClick={handleCloseBtn} aria-controls="sidebar" aria-expanded="true" class="block lg:hidden">
                ...
                <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
                    <div>
                        ...
                        <ul className="mb-6 flex flex-col gap-1.5">
                            <li>
                                <a aria-current="page" className="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-gray-800 dark:hover:bg-meta-4 bg-graydark dark:bg-meta-4 active" href="/">
                            ...
                            <li>
                                <a className="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-gray-800 dark:hover:bg-meta-4 false" href="/profile">
                            ...
                            <li>
                                <a className="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-gray-800 dark:hover:bg-meta-4 false" href="/messages">
                            ...
                            <li onClick={handleDropdownTables}>
                                <a aria-current="page" className="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-gray-800 dark:hover:bg-meta-4 false active" href="/">
                                    <svg class="fill-current" width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#clip0_130_9756)"><path d="M15.7501 0.55835H2.2501C1.29385 0.55835 0.506348 1.34585 0.506348 2.3021V15.8021C0.506348 16.7584 1.29385 17.574 2.27822 17.574H15.7782C16.7345 17.574 17.5501 16.7865 17.5501 15.8021V2.3021C17.522 1.34585 16.7063 0.55835 15.7501 0.55835ZM6.69385 10.599V6.4646H11.3063V10.5709H6.69385V10.599ZM11.3063 11.8646V16.3083H6.69385V11.8646H11.3063ZM1.77197 6.4646H5.45635V10.5709H1.77197V6.4646ZM12.572 6.4646H16.2563V10.5709H12.572V6.4646ZM2.2501 1.82397H15.7501C16.0313 1.82397 16.2563 2.04897 16.2563 2.33022V5.2271H1.77197V2.3021C1.77197 2.02085 1.96885 1.82397 2.2501 1.82397ZM1.77197 15.8021V11.8646H5.45635V16.3083H2.2501C1.96885 16.3083 1.77197 16.0834 1.77197 15.8021ZM15.7501 16.3083H12.572V11.8646H16.2563V15.8021C16.2563 16.0834 16.0313 16.3083 15.7501 16.3083Z" fill=""></path></g><defs><clipPath id="clip0_130_9756"><rect width="18" height="18" fill="white" transform="translate(0 0.052124)"></rect></clipPath></defs></svg>
                                    Tabel
                                ...
                                <div className="translate transform overflow-hidden hidden" id="tables">
                                    <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                                        ...
                                        <li>
                                            <a className="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out text-slate-400 hover:text-white false" href="/pages/file-manager">Daftar Pengguna
                                            </a>
                                        </li>
                                    </ul>
                            ...
                            <li onClick={handlePagesDropdown}>
                                ...
                                <div className="translate transform overflow-hidden hidden" id="pagesList">
                                    <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                                        <li>
                                            <a className="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white false text-slate-400" href="/pages/settings">Pengaturan
                                            </a>
                                        </li>
                                        <li>
                                            <a className="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white false text-slate-400" href="/pages/file-manager">File Manager
                                            </a>
                                        </li>
                                        <li>
                                            <a className="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white false text-slate-400" href="/pages/mail-success">Surat Terkirim
                                            </a>
                                        </li>
                                        <li>
                                            <a className="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white false text-slate-400" href="/pages/mail-success">Notifikasi
                                            </a>
                                        </li>
                                    </ul>
                                </div>
