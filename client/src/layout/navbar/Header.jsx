...
import Bell from "../../components/buttons/NotificationButton";
import Mode from "../../components/buttons/ModeButton";
import Messages from "../../components/buttons/MessagesButton";
import Profile from "../../components/buttons/ProfileButton";
        ...
        <header className="sticky top-0 z-40 flex w-full bg-white drop-shadow-md dark:bg-neutral-900 dark:drop-shadow-md">
            <div className="flex flex-grow items-center justify-between px-4 py-4 shadow-2 md:px-6 2xl:px-11">
                <div className="flex flex-grow items-center gap-5 px-4 py-4 shadow-2 md:px-6 2xl:px-11">
                    <button onClick={handleSidebar} aria-controls="sidebar" className="z-1999 block rounded-sm border border-stroke bg-white p-1 shadow-sm dark:border-neutral-700 dark:bg-neutral-900 lg:hidden">
