...
export default function Messages(){
    ...
    return(
        <li className="relative bg-gray-100 border-[0.5px] rounded-full border-slate-300 dark:border-gray-800 dark:bg-neutral-800" >
            <div onClick={handleMsg} className="group relative flex h-8 w-8 items-center justify-center rounded-full opacity-90  hover:text-blue-600  dark:text-white msgBtn cursor-pointer" ref={msgBtnRef} >
                ...
                {/* <img src={msg} alt="" /> */}
                {/* <svg className="absolute -z-50 fill-slate-500 dark:fill-slate-200 duration-300 ease-in-out" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
